export default {
    async fetch(request) {
      ...
      // If someone visits the site without a link, show a welcome message
      if (!encodedTarget) {
      ...
      try {
        ...
        // The sleek HTML, CSS, and JS for the redirect sequence
        const html = `
        <!DOCTYPE html>
        <html lang="en">
        <head>
        ...
        <body>
            ...
            <script>
                // Wait 2 seconds for fake "Verification", then start 3 second countdown
                setTimeout(() => {
